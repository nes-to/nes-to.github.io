...
Seite in Safari öffnen → Teilen-Symbol → „Zum Home-Bildschirm" – die App verhält sich dann ebenfalls wie eine native App.

Die Installationsanleitung ist auch unter Konfiguration → App installieren in der App selbst sichtbar.
